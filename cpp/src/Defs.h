...
#define MAX_TRIES		4	// Retry sends up to 4 times
#define MAX_MAX_TRIES		7	// Don't exceed this retry limit
#define ACK_TIMEOUT	2500		// How long to wait for an ACK
#define BYTE_TIMEOUT	150
#define RETRY_TIMEOUT	4000		// Retry send after 5 seconds (we might need to keep this below 10 for Security CC to function correctly)
