...
#define MAX_TRIES		4	// Retry sends up to 3 times
...
#define MAX_MAX_TRIES		4	// Don't exceed this retry limit
#define ACK_TIMEOUT	1600		// How long to wait for an ACK
#define BYTE_TIMEOUT	150
//#define RETRY_TIMEOUT	40000		// Retry send after 40 seconds
#define RETRY_TIMEOUT	2000		// Retry send after 2 seconds (we might need to keep this below 10 for Security CC to function correctly)
